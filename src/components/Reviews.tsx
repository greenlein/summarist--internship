            ...
            <div className="reviews__wrapper">
              ...
              <div className="review">
                ...
                <div className="review__body">
                  ...
                  <b>concise and accurate summaries</b> of books in a way that is easy to understand. It's also very
              ...
              <div className="review">
                ...
                <div className="review__body">
                  ...
                  <b>loves reading but doesn't have the time</b> to read every book in full, this app is for you! The
                  summaries are thorough and provide a great overview of the book's content.
                </div>
              </div>
            </div>
