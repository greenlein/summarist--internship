      ...
      <div className="plan__header--wrapper">
        <div className="plan__header">
          ...
          <figure className="plan__img--mask">
            <img
              alt="pricing"
              src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fpricing-top.4d86e93a.png&amp;w=1080&amp;q=75 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fpricing-top.4d86e93a.png&amp;w=1920&amp;q=75 2x"
              srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fpricing-top.4d86e93a.png&amp;w=1920&amp;q=75"
              width="860"
              height="722"
              decoding="async"
              data-nimg="1"
          ...
          <div className="faq__wrapper">
            ...
            <div className="accordion__card">
              ...
              <div className="collapse " style={{ height: "0px" }}>
                <div className="accordion__body">
                  While an annual plan is active, it is not feasible to switch to a monthly plan. However, once the
            ...
            <div className="accordion__card">
              ...
              <div className="collapse " style={{ height: "0px" }}>
                <div className="accordion__body">
                  Premium membership provides you with the ultimate Summarist experience, including unrestricted entry
            ...
            <div className="accordion__card">
              ...
              <div className="collapse " style={{ height: "0px" }}>
                <div className="accordion__body">
                  You will not be charged if you cancel your trial before its conclusion. While you will not have
